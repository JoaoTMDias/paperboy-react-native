import { GET_LATEST_NEWS, GET_ALL_AVAILABLE_NEWS_SOURCES } from "../../constants";
import NewsService from "../../data/services/news-service";

export function getAllAvailableNewsSources() {
...
export function getAllLatestNewsFromSource(source) {
